      ...
      input: [
        {
          content: [
            ...
            "Run runPaymentExperiment exactly once per accepted ScenarioPlan with scenarioId, seed, and injectedFaults from that plan; never substitute runUnsafeRetryFixture for a planned scenario, and return UNCERTAIN for an unsupported fault.",
